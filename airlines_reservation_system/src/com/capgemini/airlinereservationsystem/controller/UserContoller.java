			...
			try {
				...
				case 2:
					...
					try {
						...
						do {
							try {
								...
								System.out.println("press 6 for cancellation");
					...
					//					System.out.println(bean3.toString());
								...
								case 5:
									do {
										try {
											...
											validations.validatedId(passengerid);
											flag = true;
										} catch (InputMismatchException e) {
											flag = false;
											System.err.println("Id should contains only digits");
									...
									do {
										try {
											...
											validations.validatedName(firstname);
											flag = true;
										} catch (InputMismatchException e) {
											flag = false;
									...
									do {
										try {
											...
											validations.validatedName(lastname);
											flag = true;
										} catch (InputMismatchException e) {
											flag = false;
								...
								case 6:
									System.out.println(" Enter the passenger id to be removed");
